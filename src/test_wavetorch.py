...
class TestClass(unittest.TestCase):
    ...
    def test_step_2d(self):
        ...
        u1_t1 = wavetorch.step_2d(dt=0.1, dx=0.1, dy=0.1, c=1, u_prev1=u1_t1, boundary='None')
        ...
        u1_t1_boundary = wavetorch.step_2d(dt=0.1, dx=0.1, dy=0.1, c=1, u_prev1=u1_t1, boundary='t0')
